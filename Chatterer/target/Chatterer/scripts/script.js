...
function tweet()
{
	...
	try{
		var request = new XMLHttpRequest();
    		request.open("POST", BASE_URL + 'tweet/tweet/'+userName , false);
    		request.onload = function() {
        		if (request.status === 201) {
            			document.getElementById("status").innerHTML = request.status;
...
function removeTweet()
{
	...
	try{
		var request = new XMLHttpRequest();
    		request.open("POST", BASE_URL + 'tweet/destroy/'+userName , false);
    		request.onload = function() {
        		if (request.status === 201) {
            			document.getElementById("status").innerHTML = request.status;
...
function retweetTweet()
{
	...
	try{
		var request = new XMLHttpRequest();
    		request.open("POST", BASE_URL + 'tweet/retweet/'+userName , false);
    		request.onload = function() {
        		if (request.status === 201) {
            			document.getElementById("status").innerHTML = request.status;
